...
public class AutoSpacingViewLayout extends ViewGroup {

    private int marginHorizontal;
    private int marginVertical;

    public AutoSpacingViewLayout(Context context) {
        super(context);
        init();
    }

    public AutoSpacingViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoSpacingViewLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() { // Specify the margins for the children
        marginHorizontal = getResources().getDimensionPixelSize(R.dimen.dimen_5dp);
        marginVertical = getResources().getDimensionPixelSize(R.dimen.dimen_5dp);
    }
